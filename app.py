    ...
    with st.form("prediction_form", clear_on_submit=False):
        ...
        with col1:
            ...
            department     = st.selectbox("Department",
                                          ["B.Com", "B.Ed", "BBA", "BCA", "Chemistry", "Economics", "Education", "English", "Geology", "Hindi", 
                                           "ITM (BSc)", "Mathematics (BA & BSc)", "Odia", "Philosophy", "Physics", "Sanskrit", "Statistics (BSc)", 
                                           "Urdu", "Zoology", "Chemistry & Applied Chemistry", "Economics (PG)", "Education (PG)", "English (PG)", "M.Com (Regular)", "M.Com (F&C) SFC", 
                                           "Mathematics (PG)", "MSW", "MTHM", "Physics (PG)", "PMIR", "Sanskrit (PG)", "Urdu (PG)", "Zoology (PG)"])
